...
import dev.mqzen.commands.Pair;
import dev.mqzen.commands.arguments.Argument;
import dev.mqzen.commands.arguments.ArgumentNumber;
import dev.mqzen.commands.base.CommandInfo;
...
import dev.mqzen.commands.base.syntax.SyntaxFlags;
...
public final class AnnotationParser<S> {
	...
	public <E extends Enum<E>, C> void parse(C annotatedCommand) {
		...
		dev.mqzen.commands.base.Command.Builder<S> builder = dev.mqzen.commands.base.Command.builder(manager, cmdAnnotation.name())
