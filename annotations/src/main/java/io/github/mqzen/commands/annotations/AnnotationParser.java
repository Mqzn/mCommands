package io.github.mqzen.commands.annotations;

import io.github.mqzen.commands.Pair;
import io.github.mqzen.commands.arguments.Argument;
import io.github.mqzen.commands.arguments.ArgumentNumber;
import io.github.mqzen.commands.base.CommandInfo;
...
import io.github.mqzen.commands.base.syntax.SyntaxFlags;
...
public final class AnnotationParser<S> {
	...
	public <E extends Enum<E>, C> void parse(C annotatedCommand) {
		...
		io.github.mqzen.commands.base.Command.Builder<S> builder = io.github.mqzen.commands.base.Command.builder(manager, cmdAnnotation.name())
